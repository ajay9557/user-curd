...
func main() {
	...
	r.HandleFunc("/users", userHandle.PostUser).Methods("POST")
	r.HandleFunc("/users", userHandle.GetUsers).Methods("GET")
	r.HandleFunc("/user", userHandle.GetUserById).Methods("GET")
	r.HandleFunc("/users", userHandle.UpdateUser).Methods("PUT")
	r.HandleFunc("/users", userHandle.DeleteUser).Methods("DELETE")
