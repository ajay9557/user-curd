...
func (m *MockUser) CreateUsers(user models.User) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserMockRecorder) CreateUsers(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateUsers", reflect.TypeOf((*MockUser)(nil).CreateUsers), user)
}
